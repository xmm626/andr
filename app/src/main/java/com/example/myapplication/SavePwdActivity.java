...
public class SavePwdActivity extends AppCompatActivity {
        ...
        findPwd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(user) || TextUtils.isEmpty(proPwd)){
                    Toast.makeText(SavePwdActivity.this,"不能为空",Toast.LENGTH_LONG).show();
                }else if (!proPwd.equals(name)){
                    Toast.makeText(SavePwdActivity.this,"密保错误",Toast.LENGTH_LONG).show();
                }else if ( proPwd.equals(name)){
                    SharedPreferences pref2 = getSharedPreferences("userInfo",MODE_PRIVATE);
                    String password = pref2.getString(user,"");
                    Intent intent1 = new Intent(SavePwdActivity.this,ChangeActivity.class);
...
//        editor.putString("name",name);
    ...
    private void initControl() {
        ...
        btVer = findViewById(R.id.ex_ver);
